...
{	// Create our Plugin function, with $ as the argument (we pass the jQuery object over later)
	...
	{	// Our LightboxClass definition
		...
		files: {
			compressed: {
				js: {
					lightbox:	'/extras/jquery/lightbox/jquery.lightbox.min.js',
					colorBlend:	'/extras/jquery/lightbox/jquery.color.min.js'
				},
				css: {
					lightbox:	'/extras/jquery/lightbox/jquery.lightbox.css'
				}
			},
			uncompressed: {
				js: {
					lightbox:	'/extras/jquery/lightbox/jquery.lightbox.js',
					colorBlend:	'/extras/jquery/lightbox/jquery.color.js'
				},
				css: {
					lightbox:	'/extras/jquery/lightbox/jquery.lightbox.css'
				}
			...
			images: {
				prev:		'/extras/jquery/lightbox/prev.gif',
				next:		'/extras/jquery/lightbox/next.gif',
				blank:		'/extras/jquery/lightbox/blank.gif',
				loading:	'/extras/jquery/lightbox/loading.gif'
			}
		},
		...
		text: {
			...
			of:			'из',
			close:		'Закрыть X',
			closeInfo:	'Щелкните за пределами картинки, для закрытия.',
			download:	'Скачать.',
			help: {
				close:		'Закрыть',

...
<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Nonbreaking Space Box:</strong></span>
<br />
This option will enable the Nonbreaking Space Box.

<br /><br />

<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Usage:</strong></span>
<br />
Placing a check in the box will enable the button in your visual editor.  Basically, this button allows the user to add unlimited nonhreaking spaces within the post/page content.  By default, wordpress will remove redundant blank spaces.  This feature will prevent the redundant spaces from being removed.  This can help tremendously with issues such as alignment problems.

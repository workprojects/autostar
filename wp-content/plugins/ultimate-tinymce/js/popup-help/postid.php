<html><head>
<title>Post/Page ID Column</title>
...
<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Post/Page ID Column:</strong></span>
<br />
This option will enable a new column in the admin panel when viewing all posts or all pages.

<br /><br />

<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Usage:</strong></span>
<br />
A new column is created in the admin panel.  This column will list the ID number of each post or page.  This is extremely userful when using plugins which require the ID number of a post or page.  

<br /><br />

<img src="images/postid.png" border="1px solid #000000" /><br />
<em>View of the PostID column in the admin panel.</em><br /><br />

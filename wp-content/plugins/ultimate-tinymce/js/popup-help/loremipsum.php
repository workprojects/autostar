<html><head>
<title>Lorem Ipsum Button</title>
...
<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Lorem Ipsum Button:</strong></span>
<br />
This option will enable the Lorem Ipsum button.

<br /><br />

<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Usage:</strong></span>
<br />
This button is most useful during development or testing of a blog or website.  It will generate any user-defined quantity and type of "dummy" text.<br /><br />

You may currently choose from paragraphs, sentences, ordered lists, and unordered lists.  Additionally, select from five different langanges (including English!) <br /><br />

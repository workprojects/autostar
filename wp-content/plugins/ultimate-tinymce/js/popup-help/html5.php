...
<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>HTML5 Tags Button:</strong></span>
<br />
This option will enable the HTML5 Tags button.

<br /><br />

<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Usage:</strong></span>
<br />
Use this button to insert any HTML5 compliant tag into the editor.  The button will open a popup with a list of all available tags.  Simply select your content in the editor, click the button, choose the tag from the popup, and it's automatically inserted into the content editor... wrapping any highlighted selection.<br /><br />

This plugin is brand new, and still in the process of development.  However, it's stable enough to release for usage with Wordpress.  Please feel free to report any bugs to me using the contact method in the admin panel.<br /><br />

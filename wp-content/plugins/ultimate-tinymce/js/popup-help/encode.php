<html><head>
<title>Encode/Decode Buttons</title>
...
<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Encode/Decode Buttons:</strong></span>
<br />
This option will enable the Encode/Decode Buttons.

<br /><br />

<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Usage:</strong></span>
<br />
These buttons can be used to encode and decode selected text.  It uses an MD5 hash algorithm to decode the text.  Only another person, with this same plugin installed, will be able to decode the text.  This can be a fun little fature... with a variety of uses.

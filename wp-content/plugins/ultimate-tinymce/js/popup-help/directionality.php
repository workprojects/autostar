<html><head>
<title>Text Direction Button</title>
...
<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Text Direction Button:</strong></span>
<br />
This option will enable the Text Direction Buttons.

...
NOTE:  To use these anchors, it's best to have the Advanced Insert/Edit Link option enabled.  If you truly understand the HTML behind anchors, then you could probably use the default wordpress insert/edit link button.<br /><br />

<img src="images/anchor.png" border="1px solid #000000" /><br />
<em>Highlight your text, click the anchor button, and name the anchor.</em><br /><br />

<img src="images/anchor2.png" border="1px solid #000000" /><br />
<em>Highlight the placement of the link, click the insert/edit link button, and select your anchor name from the dropdown list.</em><br /><br />

...
<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Span Box:</strong></span>
<br />
This option will add a "SPAN" button to the visual editor.  It will wrap the selected content with span tags.

<br /><br />

<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Usage:</strong></span>
<br />
This button/plugin is intended to work primarily with my <a href="http://www.plugins.joshlobe.com/ultimate-tinymce-classes-and-ids/">Ultimate Tinymce Classes and IDs</a> addon.  (Although you may certainly find other uses for the button)

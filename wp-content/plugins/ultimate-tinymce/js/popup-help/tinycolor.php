<html><head>
<title>Change Colors of TinyMCE Editor</title>
...
<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Change Colors of TinyMCE Editor</strong></span>
<br />
This selection box simply gives you a few neat choices on background colors for the tinymce editor when creating your posts/pages.

<br /><br />

<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Usage:</strong></span>
<br />
Select one of the color options, and the associated stylesheet will automatically be loaded when the tinymce editor opens.

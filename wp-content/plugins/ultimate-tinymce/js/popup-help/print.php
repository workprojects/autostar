...
<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Print Box:</strong></span>
<br />
This option will enable the Print Box.  This button will be added to row Four of the visual editor.
...
I'm still trying to come up with a good reason to have this feature... so please let me know if you use it for anything useful :)

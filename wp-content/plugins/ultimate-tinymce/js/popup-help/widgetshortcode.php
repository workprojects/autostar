...
<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Widget Shortcode:</strong></span>
<br />
This option allows the user to use any shortcodes in widget areas.

<br /><br />

<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Usage:</strong></span>
<br />
Simply insert a text widget, or use an existing one, and insert your shortcode.
